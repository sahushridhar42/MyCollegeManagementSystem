...
{
    public partial class GetStudentDetailsByBranchAndYear : System.Web.UI.Page
    {
        ...
        private void DisplayReport()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~//Reports//RptGetStudentDetailsByBranchandAcadamicYear.rdlc");
        ...
        private DataTable Getdetailsa()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_Get_Student_ByAcadamicYear_And_BranchID", con);
                cmd.CommandType = CommandType.StoredProcedure;



                CollegeMgmSystemDataSet.sp_Get_Student_ByAcadamicYear_And_BranchIDDataTable tp = new CollegeMgmSystemDataSet.sp_Get_Student_ByAcadamicYear_And_BranchIDDataTable();
