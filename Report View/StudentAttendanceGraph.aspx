<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentAttendanceGraph.aspx.cs" Inherits="CollegeManagementSystem.Reports.StudentAttendanceGraph" %>
...
<body>
    ...
    <div>
        ...
        <div class=" container info">
             <center>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="696px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="653px" style="margin-right: 0px">
            
            <LocalReport ReportEmbeddedResource="CollegeManagementSystem.Reports.rptStudentAttandanceGraph.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="CollegeMgmSystemDataSetTableAdapters.pro_getAttendanceGraphTableAdapter"></asp:ObjectDataSource>
        </center>
        </div>
