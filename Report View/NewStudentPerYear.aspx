...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewStudentPerYear.aspx.cs" Inherits="CollegeManagementSystem.Report_View.NewStudentPerYear" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">Admission Year :&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td class="auto-style5">
                    <asp:DropDownList ID="ddladdyear" runat="server" Height="18px" Width="200px">
        ...
        <div>
<rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1348px"></rsweb:ReportViewer>
