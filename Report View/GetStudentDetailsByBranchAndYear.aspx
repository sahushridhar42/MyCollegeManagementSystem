<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetStudentDetailsByBranchAndYear.aspx.cs" Inherits="CollegeManagementSystem.Report_View.GetStudentDetailsByBranchAndYear" %>
    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td class="auto-style5">
                    <asp:Button ID="Button1" runat="server" Height="37px" Text="Show Report" Width="146px" OnClick="Button1_Click" class="btn btn-info"/>
                </td>
                <td class="auto-style4">&nbsp;</td>
            </tr>
            <tr>
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1293px">
            </rsweb:ReportViewer>
